...
import { rlLimaTitikSatuValidasi } from "../models/RLLimaTitikSatuValidasiModel.js";
import { rlLimaTitikDuaValidasi } from "../models/RLLimaTitikDuaValidasiModel.js";
import { rlLimaTitikTigaValidasi } from "../models/RLLimaTitikTigaValidasiModel.js";

export const getDataRLLimaTitikSatuValidasi = (req, res) => {
  if (!req.query.rsId) {
...
// export const insertDataRLLimaTitikSatuValidasi = async (req, res) => {
...
//     const dataExist = await rlLimaTitikSatuValidasi.findOne({
//       where: {
//         rs_id: req.body.rsId,
//         periode: periode,
//       },
...
//     const result = await rlLimaTitikSatuValidasi.create({
//       rs_id: req.body.rsId,
...
// export const updateDataRLLimaTitikSatuValidasi = async (req, res) => {
//   const schema = Joi.object({
//     statusValidasiId: Joi.number().required(),
//     catatan: Joi.string().when("statusValidasiId", {
//       is: 1,
...
//     await rlLimaTitikSatuValidasi.update(
//       {
//         status_validasi_id: req.body.statusValidasiId,
//         catatan: req.body.catatan,
//         user_id: req.user.id,
...
export const insertDataRLLimaTitikSatuValidasi = async (req, res) => {
  ...
  try {
    ...
    // RL 5.2
    const dataExist52 = await rlLimaTitikDuaValidasi.findOne({
      where: {
        rs_id: req.body.rsId,
        periode: periode,
      },
    ...
    if (dataExist52) {
      await rlLimaTitikDuaValidasi.update(
        {
          status_validasi_id: req.body.statusValidasiId,
          catatan: req.body.catatan,
          user_id: req.user.id,
      ...
      await rlLimaTitikDuaValidasi.create(
        {
          rs_id: req.body.rsId,
          jenis_periode: req.body.jenisPeriode,
          periode: periode,
    ...
    // RL 5.3
    const dataExist53 = await rlLimaTitikTigaValidasi.findOne({
      where: {
        rs_id: req.body.rsId,
        periode: periode,
      },
    ...
    if (dataExist53) {
      await rlLimaTitikTigaValidasi.update(
        {
          status_validasi_id: req.body.statusValidasiId,
          catatan: req.body.catatan,
          user_id: req.user.id,
      ...
      await rlLimaTitikTigaValidasi.create(
        {
          rs_id: req.body.rsId,
          jenis_periode: req.body.jenisPeriode,
          periode: periode,
...
export const updateDataRLLimaTitikSatuValidasi = async (req, res) => {
  ...
  try {
    ...
    const buildPayload = (extra = {}) => {
      ...
      // ❗ hanya inject catatan jika bukan status 2
    ...
    // ✅ RL 5.1
    // ====================
    await rlLimaTitikSatuValidasi.update(buildPayload(), {
      where: { id: req.params.id },
      transaction,
    });
    ...
    if (dataExist52) {
      await rlLimaTitikDuaValidasi.update(buildPayload(), {
        where: {
          rs_id: dataExist.rs_id,
          periode: dataExist.periode,
        },
    ...
    if (dataExist53) {
      await rlLimaTitikTigaValidasi.update(buildPayload(), {
        where: {
          rs_id: dataExist.rs_id,
          periode: dataExist.periode,
        },
